...
def getManageFlightsMenu():
    while True:
        ...
        print("3. View Flights by Criteria (Status or Destination)")
...
def getUpdateFlightRecord():
    ...
    # 6. Show updated table for verification
    print("\nYour Record:")
    time.sleep(2)
...
attributeGuidance = {
    ...
    "pilot": {
        ...
        "dob": "(YYYY-MM-DD)", #in future make sure that this is greater than today + min age to fly and less than max age
